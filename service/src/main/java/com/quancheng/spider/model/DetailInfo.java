...
public class DetailInfo {
    ...
    private String hasFoodSafeInfo;
    ...
    public String getHasFoodSafeInfo() {
        return hasFoodSafeInfo;
    }

    public void setHasFoodSafeInfo(String hasFoodSafeInfo) {
    ...
    public void setIsMeishi(String isMeishi) {
